...
from ._types import InputField, generate_model_from_fields
...
async def create_prediction_agent_and_get_predictions(
        ...
        ctx: Context,
        num_experts: Annotated[str, Field(description="The number of experts to consult when forming consensus")],
